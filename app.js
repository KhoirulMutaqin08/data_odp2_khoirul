...
const API_URL = 'https://script.google.com/macros/s/AKfycbwRPMTu1h21falidkzvz21RHawl_8eAcnuSJO6AytMZVv6pWp5QOOJ3omP0PhWAGI08IA/exec';
...
btnOpenSheet.addEventListener('click', () => {
  const ssId = '1Kg2B-gYcGfeu_5B-UrAxPOLl5VAve31_mCj74uF8owI';
...
async function onSelectNamaJalan(nama){
  ...
  try {
    ...
    const lines = matchData.matches.map((m, idx) => {
      ...
      const dis  = m.distribusi || m.dis || 'Dis Belum Tersedia';
